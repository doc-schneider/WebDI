...
path = '//192.168.178.53/' + 'Stefan/DigitalImmortality/Document and Event Tables/'
config.start_interval = (dtm.datetime.strptime('2020-12-01 12:31:15', '%Y-%m-%d %H:%M:%S'),
                         dtm.datetime.now())
#config.use_thumbnail = True
config.documenttable = SQLiteFactory.read_sqlite_table(path + 'stefan.db', 'iphone')
